 ...
 * @class
 * @constructor
 * @param {TableNode} [tableNode] Reference to a table instance
 */
...
TableMatrix.Prototype = function() {
   ...
   *
   * This is called by TableNode on structural changes.
   */
   ...
   *
   * @param {Number} [col]
   * @return {TableCell[]} The cells of a column
   */
   ...
   *
   * @param {Number} [row]
   * @return {TableCell[]} The cells of a row
   */
   ...
   *
   *
   * @param {TableCell} [startCellNode] start anchor
   * @param {TableCell} [endCellNode] end anchor
   * @return {TableMatrix.Rectangle}
   */
   ...
   *
   * @param {TableMatrix.Rectangle} [rect]
   * @return {TableCell[]}
   */
   ...
   *
   * @param {TableMatrix.Rectangle} [rect]
   * @return {TableMatrix.Rectangle} A new rectangle
   */
   ...
   *
   * @return {TableCell} The cell or null if not found
   */
