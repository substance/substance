...
test('SnapshotEngine: Should error when getting snapshot that does not exist', function (t) {
...
test('SnapshotEngine: Get existing snapshot (straight)', function (t) {
...
test('SnapshotEngine: Get existing snapshot (computed from scratch)', function (t) {
...
test('SnapshotEngine: Get existing snapshot (computed)', function (t) {
