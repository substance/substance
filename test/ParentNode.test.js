...
test('ParentNode: nodes referenced via CHILD should have parent set after creation', t => {
  ...
  t.deepEqual(child.getXpath().toArray(), [{ id: 'a' }, { id: 'b', property: 'foo' }], 'xpath of child node should be correct')
  t.end()
})
...
test('ParentNode: setting CHILD to null should remove parent link', t => {
  ...
  t.deepEqual(child.getXpath().toArray(), [{ id: 'b' }], 'xpath of child node should be correct')
  t.end()
})
...
test('ParentNode: parents should be updated when replacing a CHILD', t => {
  ...
  t.deepEqual(child1.getXpath().toArray(), [{ id: 'a' }, { id: 'b', property: 'foo' }], 'xpath of child1 should be correct')
  t.deepEqual(child2.getXpath().toArray(), [{ id: 'c' }], 'xpath of child2 should be correct')
  ...
  t.deepEqual(child1.getXpath().toArray(), [{ id: 'b' }], 'xpath of child1 should be correct')
  t.deepEqual(child2.getXpath().toArray(), [{ id: 'a' }, { id: 'c', property: 'foo' }], 'xpath of child2 should be correct')
  t.end()
})
...
test('ParentNode: CHILDREN should have parent', t => {
  ...
  t.ok(child1.getParent() === parent, 'child1 should have parent')
  t.ok(child2.getParent() === parent, 'child2 should have parent')
  t.deepEqual(child1.getXpath().toArray(), [{ id: 'a' }, { id: 'b', property: 'foo', pos: 0 }], 'xpath of child1 should be correct')
  t.deepEqual(child2.getXpath().toArray(), [{ id: 'a' }, { id: 'c', property: 'foo', pos: 1 }], 'xpath of child2 should be correct')
  t.end()
})
...
test('ParentNode: inserted CHILDREN should have parent', t => {
  ...
  t.ok(child2.getParent() === parent, 'child2 should have parent')
  t.deepEqual(child1.getXpath().toArray(), [{ id: 'a' }, { id: 'b', property: 'foo', pos: 1 }], 'xpath of child1 should be correct')
  t.deepEqual(child2.getXpath().toArray(), [{ id: 'a' }, { id: 'c', property: 'foo', pos: 0 }], 'xpath of child2 should be correct')
  t.end()
})
...
test('ParentNode: setting CHILDREN should update parent appriately', t => {
  ...
  t.deepEqual(child1.getXpath().toArray(), [{ id: 'b' }], 'xpath of child1 should be correct')
  t.deepEqual(child2.getXpath().toArray(), [{ id: 'a' }, { id: 'c', property: 'foo', pos: 0 }], 'xpath of child2 should be correct')
  t.deepEqual(child3.getXpath().toArray(), [{ id: 'a' }, { id: 'd', property: 'foo', pos: 1 }], 'xpath of child3 should be correct')
  t.end()
})
